(function($){
  $(function(){
    ...
    var options = [
      ...
      {selector: '#connect-list', offset: 150, callback: function(el) {
        Materialize.showStaggeredList($(el));
      } },
      {selector: '#connect-pic', offset: 200, callback: function(el) {
      ...
      {selector: '#wog-list', offset: 150, callback: function(el) {
        Materialize.showStaggeredList($(el));
      } },
      {selector: '#wog-pic', offset: 200, callback: function(el) {
        Materialize.fadeInImage($(el));
